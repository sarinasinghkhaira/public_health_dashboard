...
cancer_admissions_scotland <- read_csv(here("clean_data/cancer_admissions.csv")) %>% drop_na() %>% 
  filter(reference_area == "Scotland") %>% 
  mutate(longterm_condition = "cancer")
cbd_admissions_scotland <- read_csv(here("clean_data/cerebrovascular_disease_admissions.csv"))  %>% 
  drop_na() %>% 
  filter(reference_area == "Scotland") %>% 
  mutate(longterm_condition = "cerebrovascular_disease")
chd_admissions_scotland <- read_csv(here("clean_data/coronary_heart_disease_admissions.csv"))  %>% 
  drop_na() %>% 
  filter(reference_area == "Scotland") %>%
  mutate(longterm_condition = "coronary_heart_disease")
ddd_admissions_scotland <- read_csv(here("clean_data/disease_digestive_system_admissions.csv"))  %>% 
  drop_na() %>% 
  filter(reference_area == "Scotland") %>% 
  mutate(longterm_condition = "disease_digestive_system")
respiratory_admissions_scotland <- read_csv(here("clean_data/respiratory_disease_hospital_admissions.csv"))  %>% 
  drop_na() %>% 
  filter(reference_area == "Scotland") %>% 
...
write_csv(longterm_conditions_all, here("clean_data/longterm_conditions_all.csv"))
